...
Provide helpful, India-specific advice about green hydrogen infrastructure. Keep responses practical and relevant to Indian context.`;
    ...
    const text = completion.choices?.[0]?.message?.content || "I apologize, but I couldn't process your request at the moment. Please try asking about India's green hydrogen infrastructure or specific locations for hydrogen plants.";
